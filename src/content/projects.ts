...
export const projects: Project[] = [
  ...
  },
  {
    ...
    entry: '/aieewa',
    features: [
      'RAG 기반 문항 생성과 문서 기반성 자기검증(1~4점)',
      '예시문 · 평가 문항 · 조건 · 모범 답안 · 채점 기준 · 성취수준별 예시를 한 세트로 생성',
      '분석적 3영역(각 0~2점) + 총체적 A/B/C 채점',
      '근거 채점(AAS): 교사 채점 예시 few-shot, 영역별 채점 근거, 정확성·피드백 품질 자기검증',
      '생성·채점 과정을 한 줄씩 보여 주는 진행 표시',
    ],
